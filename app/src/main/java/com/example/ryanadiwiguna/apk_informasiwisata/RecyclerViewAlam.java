...
public class RecyclerViewAlam extends RecyclerView.Adapter <RecyclerViewAlam.MyHolder> {
    ...
    public RecyclerViewAlam(Context context) {
    ...
    @Override
    public RecyclerViewAlam.MyHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(RecyclerViewAlam.MyHolder holder, final int position) {
